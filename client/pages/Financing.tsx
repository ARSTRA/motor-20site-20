...
export default function Financing() {
  ...
  const calculatePayment = () => {
    ...
    const monthlyRate = interestRates[creditScore as keyof typeof interestRates] / 12;
  ...
  const financingOptions = [
    {
      ...
      features: ["No prepayment penalties", "Fixed interest rates", "Online account management"]
    },
    {
      ...
      features: ["Lower monthly payments", "Warranty coverage included", "Upgrade options available"]
    },
    {
      ...
      features: ["Extended warranty", "Rigorous inspection", "Roadside assistance"]
    },
    {
      ...
      features: ["No financing fees", "Immediate ownership", "Negotiation advantages"]
    }
  ];
  ...
  const creditScoreRanges = [
    { range: "Excellent (750+)", rate: "3.49%", color: "text-green-600 bg-green-50" },
    { range: "Good (700-749)", rate: "4.49%", color: "text-blue-600 bg-blue-50" },
    { range: "Fair (650-699)", rate: "6.49%", color: "text-yellow-600 bg-yellow-50" },
    { range: "Poor (Below 650)", rate: "8.49%", color: "text-red-600 bg-red-50" }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl lg:text-2xl text-gray-100 mb-12 max-w-4xl mx-auto leading-relaxed">
              Explore our comprehensive financing options designed to make luxury vehicle ownership 
              accessible. Get pre-approved in minutes and drive home your perfect vehicle today.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
                <div className="text-4xl font-bold text-gold-300 mb-2">3.49%</div>
                <div className="text-ocean-100">Starting APR</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
                <div className="text-4xl font-bold text-gold-300 mb-2">2 Min</div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Use our advanced calculator to estimate your monthly payments and find the perfect financing solution
            </p>
          </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <Slider
                      value={loanAmount}
                      onValueChange={(value) => setLoanAmount(value as [number])}
                      max={300000}
                      min={20000}
                      step={5000}
                      className="w-full"
                  ...
                  <div>
                    ...
                    <Slider
                      value={downPayment}
                      onValueChange={(value) => setDownPayment(value as [number])}
                ...
                <div className="bg-gradient-to-br from-ocean-50 to-forest-50 rounded-2xl p-8">
                  <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Payment Breakdown</h3>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="bg-white rounded-xl p-4 text-center">
                        <div className="text-2xl font-bold text-forest-600">
                          ${(monthlyPayment * loanTerm[0] - (loanAmount[0] - downPayment[0])).toLocaleString()}
                        </div>
                    ...
                    <Alert className="border-gold-200 bg-gold-50">
                      ...
                      <AlertDescription className="text-gold-800">
                        This is an estimate. Actual rates may vary based on credit approval and vehicle selection.
                      </AlertDescription>
                    </Alert>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We offer a variety of financing solutions to fit every budget and lifestyle preference
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {financingOptions.map((option, index) => (
              <Card key={index} className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 rounded-3xl border-2 border-transparent hover:border-ocean-200">
                <CardHeader className={`bg-gradient-to-r ${option.color} text-white rounded-t-3xl p-6`}>
                  <div className="text-center">
                ...
                <CardContent className="p-6">
                  <div className="text-center mb-6">
                    <div className="text-2xl font-bold text-gray-900 mb-1">{option.rate}</div>
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 to-sunset-50">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Get pre-approved in minutes and shop with confidence knowing your budget
            </p>
          </div>
              ...
              {!showResults ? (
                <form onSubmit={handlePreApprovalSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setPreApprovalForm({...preApprovalForm, annualIncome: e.target.value})}
                    ...
                    <div>
                      ...
                      <Select 
                        ...
                        onValueChange={(value) => setPreApprovalForm({...preApprovalForm, employmentType: value})}
                      >
                  ...
                  <Alert className="border-blue-200 bg-blue-50">
                    ...
                    <AlertDescription className="text-blue-800">
                      Your information is secure and will only be used for pre-approval processing. We never share your personal data.
                    </AlertDescription>
                  </Alert>
                ...
                <div className="text-center space-y-6">
                  ...
                  <p className="text-xl text-gray-700 mb-6">
                    You've been pre-approved for up to <span className="font-bold text-green-600">${loanAmount[0].toLocaleString()}</span>
                  </p>
                  <div className="bg-green-50 border border-green-200 rounded-xl p-6 mb-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                      <div>
                        <div className="text-2xl font-bold text-green-600">3.49%</div>
                        <div className="text-sm text-gray-600">Your Rate</div>
                      </div>
                      <div>
                        <div className="text-2xl font-bold text-green-600">${monthlyPayment}</div>
                  ...
                  <div className="flex gap-4 justify-center">
                    ...
                    <Button variant="outline" className="border-2 border-sunset-500 text-sunset-600 px-8 py-3 rounded-xl">
                      Save Pre-Approval
                    </Button>
                  </div>
                </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience the difference of working with a trusted luxury automotive financing partner
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, index) => (
              <Card key={index} className="text-center p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 rounded-2xl border-2 border-gray-100">
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 to-forest-50">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Understanding your credit score helps you get the best possible financing terms
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {creditScoreRanges.map((range, index) => (
              <Card key={index} className="hover:shadow-xl transition-all duration-300 rounded-2xl">
                <CardContent className="p-6">
                  <div className={`inline-flex items-center rounded-full px-3 py-1 text-sm font-semibold mb-4 ${range.color}`}>
                    {range.range}
                  </div>
                  <div className="text-center">
            ...
            <Card className="max-w-2xl mx-auto rounded-2xl border-2 border-blue-200 bg-blue-50">
              <CardContent className="p-8">
                <div className="flex items-center justify-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-blue-800">Improve Your Credit Score</h3>
                </div>
                <p className="text-blue-700 mb-6">
                  We can help you understand and improve your credit score for better financing terms
                </p>
      ...
      <section className="py-20 bg-gradient-to-br from-ocean-600 via-forest-600 to-sunset-600 text-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl lg:text-2xl mb-12 leading-relaxed max-w-3xl mx-auto text-gray-100">
            Our financing specialists are standing by to help you secure the perfect loan for your dream vehicle. 
            Get started today and drive home tomorrow.
          </p>
