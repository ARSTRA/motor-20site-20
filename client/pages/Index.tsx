  ...
  return (
    <Layout>
          ...
          <div className="max-w-7xl mx-auto px-4 w-full">
            <div className="max-w-2xl">
              <h1 className="text-5xl lg:text-7xl font-bold text-white mb-6 leading-tight">
                Discover Your
                <span className="bg-gradient-to-r from-gold-400 via-sunset-400 to-gold-400 bg-clip-text text-transparent block">Perfect Journey</span>
              </h1>
              <p className="text-xl lg:text-2xl text-gray-100 mb-8 leading-relaxed max-w-2xl">
                Where luxury meets adventure. Experience our curated collection of
                premium vehicles designed for those who demand excellence.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="text-lg px-8 py-4 bg-gradient-to-r from-ocean-500 to-forest-500 hover:from-ocean-600 hover:to-forest-600 text-white font-bold shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300">
                  Explore Collection
                </Button>
                <Button size="lg" variant="outline" className="text-lg px-8 py-4 text-white border-2 border-gold-400 hover:bg-gold-400 hover:text-gray-900 font-bold shadow-xl transition-all duration-300">
                  Book Experience
                </Button>
              </div>
            </div>
      ...
      <section className="bg-white shadow-2xl -mt-20 relative z-30 mx-4 lg:mx-8 rounded-2xl border-t-4 border-gradient-to-r from-ocean-500 via-forest-500 to-sunset-500">
        <div className="max-w-6xl mx-auto p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">Advanced search to discover your ideal luxury vehicle</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-3">Make</label>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 via-ocean-50 to-forest-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <Badge variant="outline" className="mb-4 text-ocean-600 border-ocean-300">Vehicle Categories</Badge>
            <h2 className="text-5xl font-bold bg-gradient-to-r from-ocean-700 via-forest-700 to-sunset-700 bg-clip-text text-transparent mb-6">Browse by Category</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">Discover your perfect vehicle from our carefully curated categories, each offering unique experiences and luxury</p>
          </div>
              ...
              >
                <Card className="text-center p-8 hover:shadow-2xl transition-all duration-500 group-hover:-translate-y-2 bg-gradient-to-br from-white to-gray-50 border-2 border-transparent hover:border-ocean-200 rounded-2xl">
                  <CardContent className="p-0">
                    ...
                    <h3 className="font-bold text-gray-900 mb-3 text-lg group-hover:text-ocean-600 transition-colors">{category.name}</h3>
                    <p className="text-sm text-gray-600 font-medium">
                      <span className="text-ocean-600 font-bold">{category.count}</span> premium vehicles
                    </p>
                    <div className="mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <span className="text-xs text-forest-600 font-semibold">Explore Collection →</span>
                    </div>
                  </CardContent>
                </Card>
              </Link>
      ...
      <section className="py-20 bg-gradient-to-br from-white via-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <Badge variant="outline" className="mb-6 text-gold-600 border-gold-300 px-4 py-2">Premium Collection</Badge>
            <h2 className="text-5xl font-bold bg-gradient-to-r from-ocean-700 via-forest-700 to-sunset-700 bg-clip-text text-transparent mb-6">Featured Luxury Vehicles</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">Handpicked masterpieces from the world's most prestigious manufacturers, each offering uncompromising luxury and performance</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredCars.map((car) => (
              <Card key={car.id} className="group overflow-hidden hover:shadow-2xl transition-all duration-500 hover:-translate-y-1 bg-gradient-to-br from-white to-gray-50 rounded-2xl border-2 border-transparent hover:border-ocean-200">
                <div className="relative">
                  ...
                  <div className="absolute top-4 left-4">
                    <Badge className="bg-gradient-to-r from-gold-500 to-gold-600 text-white font-bold shadow-lg">Premium</Badge>
                  </div>
                ...
                <CardContent className="p-8">
                  <div className="flex items-center justify-between mb-4">
                    <Badge variant="secondary" className="bg-gradient-to-r from-forest-100 to-forest-200 text-forest-700 font-semibold">{car.category}</Badge>
      ...
      <section className="py-20 bg-gradient-to-r from-ocean-700 via-forest-700 to-sunset-700 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-200">Trusted by thousands of satisfied customers</p>
          </div>
            ...
            {stats.map((stat, index) => (
              <div key={index} className="text-center group">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                  ...
                  <div className="text-4xl font-bold mb-3 text-gold-300">{stat.value}</div>
      ...
      <section className="py-24 bg-gradient-to-br from-ocean-600 via-forest-600 to-sunset-600 text-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl lg:text-2xl mb-12 leading-relaxed max-w-3xl mx-auto text-gray-100">
            Join thousands of satisfied customers who've discovered their perfect vehicle
            with Alpine Motors. Experience personalized service, exclusive offers, and the
            luxury you deserve.
          </p>
          <div className="flex flex-col lg:flex-row gap-6 justify-center items-center">
            <Button size="lg" className="text-lg px-10 py-4 bg-white text-ocean-600 hover:bg-gray-100 font-bold rounded-2xl shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300">
              Schedule Private Viewing
            </Button>
            <Button size="lg" variant="outline" className="text-lg px-10 py-4 border-2 border-gold-300 text-gold-300 hover:bg-gold-300 hover:text-ocean-900 font-bold rounded-2xl transition-all duration-300">
              Get Instant Quote
            </Button>
            <Button size="lg" variant="outline" className="text-lg px-10 py-4 border-2 border-white text-white hover:bg-white hover:text-ocean-600 font-bold rounded-2xl transition-all duration-300">
              Financing Options
            </Button>
          </div>
        </div>
